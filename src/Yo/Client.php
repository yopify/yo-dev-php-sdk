...
class Client
{
     ...
     */
    private $endpoint = 'https://local.yopify.com/api/v1';
    ...
    {
        return $this->call('/events/' . $this->appId . '/' . $id);
    }
     ...
     * @return $data
     */
    public function getEvents($limit = 30, $page = 1)
    {
        $data = $this->call(
            [
                'URL'    => '/api/v1/events/' . $this->appId,
                'METHOD' => 'GET',
                'DATA'   => [
                    'limit' => $limit,
                    'page'  => $page
    ...
    public function updateEvent($event)
    {
        ...
        return $this->call([
                'URL'    => '/events/' . $this->appId . '/' . $event['id'],
                'METHOD' => 'PATCH',
                'DATA'   => $event
            ]
        );
